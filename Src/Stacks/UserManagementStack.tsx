...
import UpdateUserAccessPermission from '../Screens/HomeScreens/UserManagement/UpdateUserAccessPermission';
...
const UserManagementStack = ({route}: UserScreensNavigationProps) => {
  return (
    <Stack.Navigator
      ...
      <Stack.Screen
        name="UpdateUserAccessPermission"
        component={UpdateUserAccessPermission}
      />
    </Stack.Navigator>
  );
};
